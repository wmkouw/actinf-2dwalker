...
plot!(time[ix], pred_m[1,ix], ribbon=pred_s[1,ix], color="purple", label="prediction")
scatter!(time[ix], y_[ix], color="black", label="measurements")
```
